      ...
      <section id="products" className="container mt-5">
        <div className="row">

          {
            ...
            (
              <React.Fragment>
                <div className="col-4 col-med-3 mt-5 mb-5">  
                  <div className="px-5">  
                    <Range 
                  ...
                  <div className="my-5">
                      ...
                      <ul className="pl-0">
                        {
                          [5,4,3,2,1].map(star => (
                            <li style={{ cursor:"pointer", listStyle:"none" }} key={star} onClick={() => onChangeStar(star)}>
                ...
                <div className="col-6 col-md-6"> 
                  <div className="row">
                    <Products col={9} products={products} loading={loading}/>
                  </div>
                </div>
              </React.Fragment>
            ) 
